...
<body>
 ...
 <div id="spinner" class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
        ...
        <h4>Thank you for submitting your job application through our portal. We acknowledge the receipt of your application and want to assure you that we will review it thoroughly. We understand your anticipation and will notify you promptly about the status of your application. Please bear with us as we carefully assess your qualifications against the position requirements. We value your time and effort and appreciate your interest in our company. If there are any further updates or if your application progresses, we will contact you using the provided contact information. Thank you for your patience and good luck with your job search.</h4>
        </div>
         <!-- 
         <%
